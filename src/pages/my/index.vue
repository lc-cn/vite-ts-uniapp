          ...
          <template v-if="tabIndex === 0">
            <view class="column">
              ...
              <view class="card article">
                <image
                  mode="widthFix"
                  src="https://pcapi-xiaotuxian-front-devtest.itheima.net/miniapp/uploads/article_big_6.jpg"
                ></image>
              ...
              <view class="card article">
                <image
                  mode="widthFix"
                  src="https://pcapi-xiaotuxian-front-devtest.itheima.net/miniapp/uploads/article_big_7.jpg"
                ></image>
                <view class="name">彩色鹅卵石小清新防水防烫长方形餐桌圆桌布艺茶几垫电视柜盖布 鹅软石桌布yg056</view>
                <view class="price">¥899</view>
              </view>
            ...
            <view class="column">
              <view class="card article">
                <image
                  mode="widthFix"
                  src="https://pcapi-xiaotuxian-front-devtest.itheima.net/miniapp/uploads/article_big_5.jpg"
                ></image>
                <view class="name">彩色鹅卵石小清新防水防烫长方形餐桌圆桌布艺茶几垫电视柜盖布 鹅软石桌布yg056</view>
                <view class="price">¥899</view>
              </view>
              ...
              <view class="card article">
                <image
                  mode="widthFix"
                  src="https://pcapi-xiaotuxian-front-devtest.itheima.net/miniapp/uploads/article_big_3.jpg"
                ></image>
                <view class="name">彩色鹅卵石小清新防水防烫长方形餐桌圆桌布艺茶几垫电视柜盖布 鹅软石桌布yg056</view>
                <view class="price">¥899</view>
              </view>

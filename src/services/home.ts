...
/**
 * 首页-广告区域
 * @param distributionSite 说明：广告区域展示位置（投放位置 投放位置，1为首页，2为分类文章页） 默认是1
 */
 ...
 * @param
 */
export function getGuessLike(data: GetHomeArticleGuessLikeData) {
  return http<PageResult<GuessItem>>({
    method: 'GET',
    url: '/home/article/guessLike',
    data
  });
}
